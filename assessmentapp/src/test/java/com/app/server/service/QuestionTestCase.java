...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("PRtrtRNl0UMBEhlexzA4q4XjdHa0inA3nsroiKqHFVxm50g3Ch");
            question.setQuestionDetails("f");
            question.setQuestionIcon("gPEr5klUf1sIpCFsIvl7MhohIcSBGoxDPFaRKvgYVpb6jlgCPO");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("T4kpJVUXMw5GL6VirmVB8wmdbHIvH3mV0T0HiY8r6zZ8tutfmO");
            question.setQuestionDetails("V");
            question.setQuestionIcon("WRD8rdQifid70rw0LnYbgTJ1jNUPVCLaFiNmIclOK99bSXlG7v");
