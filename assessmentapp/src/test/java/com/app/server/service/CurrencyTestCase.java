...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("8b4FkxX51wNxgbCaSoVMhMSLEvE6QZR5");
            country.setCapitalLatitude(1);
            country.setCapitalLongitude(4);
            country.setCountryCode1("Lbb");
            country.setCountryCode2("zVX");
            country.setCountryFlag("GT9MEDo3K04zFXzI8pSdMxaYuQ1DVmhI9Tzjxyk3QBY1KIuAML");
            country.setCountryName("fYKo7aNQ8HIXMvQTvu0bC1LwrjI4Z7QrN9kEI2z1B3I8DcRFMo");
            country.setCurrencyCode("7Kl");
            country.setCurrencyName("voEbHrHRfdnLx3ioVvBWBtlwuBksZXQTt4hukyUKkHCc83wiop");
            country.setCurrencySymbol("Bq81ggNtkEEXUZj2Sqx4ieoFU8JPdbKh");
            country.setIsoNumeric(1);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("rfUBGixrv68MNgZTK1flcg5qU4yqSVhTo9OvWVNBmi9gZDAigl");
            currency.setUnicodeDecimal("7f8Jv5oR7a4DYwitvApUTkvsM3rBg5cYdmUEDtuJcEZZX1ZraZ");
            currency.setUnicodeHex("zg4IWKYkeJx7IsyiOp3Z5cZCqWoqxay6bo5Qi2ICiIBVUUPf91");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("JTN6ZIcoOrUEBIwFL5FIvZKhCkbqjIl5ZzMP2y563oz9axsg5Y");
            currency.setUnicodeDecimal("LSoJmp3SdLpIOOtFmwBmGlI22FTZVCd4cQazbFWPwXPfd8wXJo");
            currency.setUnicodeHex("FOKEY4CVoweUoOD05M3ERdZmK3Bx8rm1J18ix6Rz5k3M8IvsmG");
