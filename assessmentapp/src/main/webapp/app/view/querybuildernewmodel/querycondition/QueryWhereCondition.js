Ext.define('Assessmentapp.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Assessmentapp.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
