Ext.define('Assessmentapp.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Assessmentapp.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Assessmentapp.view.querybuildernewmodel.queryentitiesjoins.Query',
