Ext.define('Assessmentapp.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Assessmentapp.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Assessmentapp.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Assessmentapp.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Assessmentapp.view.querybuildernewmodel.querydetail.QueryDetail');
