Ext.define('Assessmentapp.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Assessmentapp.view.reportui.datachart.chart.RatingField','Assessmentapp.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
