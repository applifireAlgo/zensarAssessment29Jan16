Ext.define('Assessmentapp.view.mobileview.resource.ResourcePanelController', {
	...
	createTreePanel : function(current, rawData)
	{
				...
				for (var j = 0; j < this.formResourcePanel.items.length; j++) {
					...
					if(me.formResourcePanel.items.items[j].title == record.menuLabel)
						{
							var treePanel = new Ext.create('Assessmentapp.view.mobileview.resource.AppMenuTreePanel');
