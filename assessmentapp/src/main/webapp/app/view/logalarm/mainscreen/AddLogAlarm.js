 ...
 * 
 */
Ext.define('Assessmentapp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Assessmentapp.view.logalarm.mainscreen.AddLogAlarmController',
			'Assessmentapp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Assessmentapp.view.logalarm.mainscreen.AppAlarmPanel',
