 ...
 * 
 */
Ext.define('Assessmentapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Assessmentapp.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
