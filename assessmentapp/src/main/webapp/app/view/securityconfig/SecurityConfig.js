 ...
 * 
 */
Ext.define('Assessmentapp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Assessmentapp.view.securityconfig.SecurityConfigController',
			'Assessmentapp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
