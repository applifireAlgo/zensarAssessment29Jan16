Ext.define('Assessmentapp.view.googlemaps.map.MapPanelController', {
	...
	createInfoWindow : function(marker, currentJson) {
		...
		google.maps.event.addListener(marker, 'click', function() {
			...
			// mainInfoWindow =
			// Ext.create('Assessmentapp.view.googlemaps.map.MarkerInfoWindowView',{title:
	...
	loadGoogleMap : function() {
		...
		// Ext.create('Assessmentapp.view.googlemaps.map.MarkerInfoWindowView').show();
	},
	resizeMap : function() {
