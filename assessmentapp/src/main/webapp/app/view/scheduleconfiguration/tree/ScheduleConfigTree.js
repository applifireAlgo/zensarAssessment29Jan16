 ...
 * 
 */
Ext.define("Assessmentapp.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Assessmentapp.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
