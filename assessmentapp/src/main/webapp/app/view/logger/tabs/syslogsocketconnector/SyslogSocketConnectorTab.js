 ...
 * 
 */
Ext.define('Assessmentapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Assessmentapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
