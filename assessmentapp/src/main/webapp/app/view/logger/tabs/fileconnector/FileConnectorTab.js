 ...
 * 
 */
Ext.define('Assessmentapp.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Assessmentapp.view.logger.tabs.fileconnector.FileConnectorTabController'],
