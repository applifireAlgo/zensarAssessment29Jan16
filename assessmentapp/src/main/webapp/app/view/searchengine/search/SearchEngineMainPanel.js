Ext.define('Assessmentapp.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Assessmentapp.view.searchengine.search.NorthPanel', 'Assessmentapp.view.searchengine.search.SearchResult','Assessmentapp.view.searchengine.search.SearchEngineMainPanelController'],
