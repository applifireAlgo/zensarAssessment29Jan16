Ext
		.define(
				'Assessmentapp.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Assessmentapp.view.searchengine.search.documentController',
							'Assessmentapp.view.searchengine.search.RowExpander' ],
