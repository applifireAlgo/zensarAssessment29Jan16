Ext
		.define(
				'Assessmentapp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Assessmentapp.view.searchengine.search.SearchEngineMainPanelController','Assessmentapp.view.searchengine.search.PanelHeaderField' ,'Assessmentapp.view.searchengine.search.ReportGridView','Assessmentapp.view.searchengine.search.ReportChartView','Assessmentapp.view.searchengine.search.documentView','Assessmentapp.view.searchengine.search.DouMeanView','Assessmentapp.view.googlemaps.map.MapPanel'],
