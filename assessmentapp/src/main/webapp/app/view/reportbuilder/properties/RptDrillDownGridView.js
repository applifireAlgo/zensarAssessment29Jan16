Ext.define('Assessmentapp.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Assessmentapp.view.reportbuilder.properties.RptDrillDownGridController'],
