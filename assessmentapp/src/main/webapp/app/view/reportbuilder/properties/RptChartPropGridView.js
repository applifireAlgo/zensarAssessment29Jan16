Ext.define('Assessmentapp.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Assessmentapp.view.reportbuilder.properties.RptChartPropGridController'],
