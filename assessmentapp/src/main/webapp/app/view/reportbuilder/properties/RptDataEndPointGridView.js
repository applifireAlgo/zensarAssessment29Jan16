Ext.define('Assessmentapp.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Assessmentapp.view.reportbuilder.properties.RptDataEndPointGridController'],
