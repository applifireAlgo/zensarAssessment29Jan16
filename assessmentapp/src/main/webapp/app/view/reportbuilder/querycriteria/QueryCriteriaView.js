Ext.define('Assessmentapp.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Assessmentapp.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Assessmentapp.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Assessmentapp.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Assessmentapp.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
