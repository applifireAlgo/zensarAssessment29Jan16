Ext.define('Assessmentapp.view.reportbuilder.reportlist.ReportListPanelView', {
	extend : 'Ext.panel.Panel',
	requires:['Assessmentapp.view.reportbuilder.reportlist.ReportListPanelController'],
