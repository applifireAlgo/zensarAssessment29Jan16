Ext.define('Assessmentapp.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Assessmentapp.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Assessmentapp.view.reportbuilder.gridconfig.GridConfigView',
	           'Assessmentapp.view.reportbuilder.properties.PropertiesPanelView',
	           'Assessmentapp.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
