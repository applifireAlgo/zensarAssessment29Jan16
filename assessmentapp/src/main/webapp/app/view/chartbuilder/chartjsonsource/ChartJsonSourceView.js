Ext.define('Assessmentapp.view.chartbuilder.chartjsonsource.ChartJsonSourceView', {
	
	extend : 'Ext.panel.Panel',
	requires : [ 'Ext.layout.container.Column',
	             'Assessmentapp.view.chartbuilder.chartjsonsource.ChartJsonSourceController'
	           ],
	xtype : 'source-view',
	itemId:'sourceView',
